...
// line in non-decreasing order by height. Let this ordering be represented by the integer array expected where expected[i]
...
public class HeightChecker {
    public int heightChecker(int[] heights) {
        int[] clone = Arrays.stream(heights).sorted().toArray().clone();
